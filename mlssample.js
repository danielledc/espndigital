...
var dfpAdID, cacheBust, adMacro, offset = 5.0,
    ctaDelay, showLive = false,
    num = 0,
    showScheduleMessage, introText, games = [];
...
$.ajax({
    ...
    success: function(data) {
        ...
        for (var x in data) {
            var endTimeDate, endTimeMonth, teamOne = "",
                teamTwo = "";
...
function changeMessage(bannerSize) {
    ...
    //change 12:00pm and 12:00am to display Noon and Midnight
        ...
        $("#showScheduleMessage").html(showScheduleMessage + " <span class='time'>" + gameToPromote.startTimeHours + gameToPromote.startTimeMinutes + "<span class='timeZone'>" + timeOfDay + "</span></span>");
